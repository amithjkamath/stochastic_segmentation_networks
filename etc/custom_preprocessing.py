...
def fix_segmentation_labels(seg):
    ...
    array[array == 6] = 2  # Hippocampus_L
    array[array == 7] = 3  # Hippocampus_R

    array[array >= 4] = 0  # Make all others empty.
...
def preprocess(input_dir, output_dir):
    ...
    for subdir_1 in os.listdir(os.path.join(input_dir)):
        ...
        seg = fix_segmentation_labels(
            sitk.ReadImage(os.path.join(input_dir, id_) + "_labelmask_all_final.nii.gz")
        )
